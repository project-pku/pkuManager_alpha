...
namespace pkuManager.Alerts
{
    ...
    public class Alert
    {
        ...
        public static ArgumentException InvalidAlertType(AlertType? at = null) => at switch
        {
            null => new ArgumentException($"No valid AlertTypes were given to this alert method."),
            _ => new ArgumentException($"This alert method does not support the {at} AlertType")
        };
    }
}
